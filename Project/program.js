...
var clk = function(c){
  ...
  var category=["Democracy, Human Rights, and Governance","Economic Development","Education and Social Services","Environment","Health","Humanitarian Assistance","Multi-Sector","Peace and Security","Program Management"];
   var sector=["Direct Administrative Costs","Monitoring and Evaluation"];//**change for each one**************************
  ...
  var firstsector="Direct Administrative Costs";//***********************************************************
  var yearamount = 0;
  var agencyamount =0;
  var catamount =0;
  var sectoramount =0;//*********************************************************************
...
//---------------------------------------------------year array-------------------------------
 ...
 console.log(extractCata[1]);
  var extractCataNew=[];
   ...
   if(extractCata[p][4]===category[8]){//change for each category
...
d3.json("rightdata.json", function(json) {
  ...
  data = json;
  var firstname = "AE";
  var firstcat="Program Management";
  var amount = 0;
