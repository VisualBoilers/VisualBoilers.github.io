...
var clk = function(c){
  ...
  var category=["Democracy, Human Rights, and Governance","Economic Development","Education and Social Services","Environment","Health","Humanitarian Assistance","Multi-Sector","Peace and Security","Program Management"];
   var sector=["Disaster Readiness","Humanitarian Assistance - General","Migration Management","Protection, Assistance and Solutions"];//**change for each one**************************
  ...
  var firstsector="Disaster Readiness";//***********************************************************
  var yearamount = 0;
  var agencyamount =0;
  var catamount =0;
  var sectoramount =0;//*********************************************************************
...
/////------------------------------------------try sector-----------------------------
 ...
 console.log(extractCata[1]);
  var extractCataNew=[];
   ...
   if(extractCata[p][4]===category[5]){//change for each category
...
d3.json("rightdata.json", function(json) {
  ...
  data = json;
  var firstname = "AE";
  var firstcat="Humanitarian Assistance";
  var amount = 0;
